...
<body>
    ...
    <div class="hero-section" style="min-height: calc(100vh - 80px - 160px - 40px);">
        ...
        <p>A SmartCodeGen egy mesterséges intelligencia alapú eszköz, amely a legmodernebb nyelvi modelleket használja fel arra, hogy segítsen kódot generálni, magyarázatokat adni, vagy akár hibákat keresni.</p>
        <p>Csak írd le, mire van szükséged, és hagyd, hogy az AI dolgozzon helyetted!</p>
        <p>Ez az oldal hamarosan részletesebb információkat tartalmaz majd a mögöttes technológiáról és a hatékony használatról.</p>
    </div>
